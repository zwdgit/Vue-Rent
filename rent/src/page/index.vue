  ...
  <div>
    ...
    <mu-popup position="bottom" popupClass="Login-popup-bottom" :open="LoginBottom" @close="LoginBottomClose">
      <mu-content-block class="Login-Bottom">
        <mu-flat-button label="关闭" icon="clear" class="Login-Bottom-Close" @click="LoginBottomClose"/>
        <Br/>
        ...
        <mu-text-field iconClass="Phone-Input" v-model="PhoneNumber" type="number" icon="phone_iphone" labelFloat
                       fullWidth/>
